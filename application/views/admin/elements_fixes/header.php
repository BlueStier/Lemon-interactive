...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="<?php echo base_url() ?>assets/admin/image/favicon.png" />
  ...
  <meta http-equiv='refresh' content="900; URL=<?php echo base_url().'admin/dodo'?> ">
</head>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Lemon</b>Interactive</span>
    </a>
